...
|---|---|---|---|---|---|---|
| **Stock Momentum + SPY + book vol-scaling (Acct 1)** ⚠ C3 | PASS (09-25) | **+32.1%** | **-15.9%** | **2.02** | +12.4% | 58% |
| **Trend + Low-Vol, cap=1.5 (Acct 2)** | RETIRED 2026-09-25 (last: MARGINAL 09-09) | +11.8% | -13.1% | 0.90 | +8.8% | 54% |
...
A1 PASSes the CAGR ≥ 15% / Calmar ≥ 1.0 / OOS/IS ≥ 70% gates (revalidated 2026-09-25 with the SPY filter lagged one day — the same-day filter was a one-day look-ahead worth +4.7pp / +0.8 Calmar, HISTORY.md 2026-09-25 — grid phased to the live calendar, vol_target 0.18, financing modeled: OOS CAGR 32.1%, MaxDD -15.9%, Calmar 2.02, ratio 199%, bootstrap p5 +12.4%; SPY over the same window: Calmar 1.19. The 09-09 run with the look-ahead read 34.6% / 2.59; 08-12 at the old grid phase 33.0% / 2.49). **A2 RETIRED 2026-09-25** — OOS Calmar 0.90 under the gate at the anchored phase (09-09), and bug-free −6.3% vs SPY +15.6% since 2026-03-09 with live tracking the synthetic, i.e. the strategy itself; −6% over the last three months at the 1.5× vol-scaling cap. Liquidated 09-25; shadow-tracked weekly; DBMF swap parked under its crisis trigger. HISTORY.md 2026-09-25. Nothing about the strategy changed: the 07-18 PASS at 16.8% booked ~3pp of margin financing for free, and the vol_target raise is a no-op for A2 (raw vol ~7% pins the scalar at the cap either way). MARGINAL is allowed for paper; the pre-committed Q4 trigger stands — live Calmar < 1.0 at the review → kill or DBMF swap. **A4 RETIRED 2026-07-13** — walk-forward edge decay (newest window +9.6% CAGR, Calmar 0.87) + bug-era live drag never re-validated; canonical narrative in `HISTORY.md`.
