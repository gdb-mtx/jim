...
- Account 1: 15 stocks (SM + SPY Filter + book vol-scaling since 07-18, vol_target 0.18 since 08-12) — live since 2026-03-10, OOS CAGR 33.0%. Clean-window live matches signal (no drag); prior SPY lag was the un-relevered design, fixed by the overlay.
- Account 2: 34 positions (Trend + Low-Vol) — live since 2026-03-10. cap=1.5 restored 2026-07-18; MARGINAL 12.9% on the honest financing model (08-12). Live ~flat pre-restore; levered from the 07-22 rebalance; Q4 Calmar < 1.0 → kill or DBMF swap.
