...
A1 OOS (revalidated 2026-09-09 at the anchored re-ranking phase, financing modeled): PASS 34.6%/Calmar 2.59 (SPY over the same 2023→ window: 22.0%/1.17). The book is 100% A1; no book split to maintain. Realistic live estimate: A1 Calmar ~2 (correlations spike in crises; calm-regime extension to 1.5× scales losing days too). Historical combined numbers are in git history and `HISTORY.md`.
...
- Account 1: 15 stocks (SM + SPY Filter + book vol-scaling since 07-18, vol_target 0.18 since 08-12) — live since 2026-03-10, OOS CAGR 34.6%. **Clean-window drag was the stale-ranking bug** (HISTORY.md 2026-09-09): at the right grid phase the signal beat SPY +1.7pp over 04-21→09-09 while live lost 6.2pp; from 09-21 live trades the same book the backtest does.
