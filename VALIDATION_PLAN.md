...
**Context:** `CLAUDE.md` for system state, `BREAKTHROUGH.md` for strategic framing, `backtesting/metrics.py` for the full scorecard, `scripts/run_validation.py` for the runner.
